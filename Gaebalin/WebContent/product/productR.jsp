...
<meta name="viewport"
    ...
    function fn_buy(sessionValue, loginUrl){
	...
	function fn_cart(sessionValue, loginUrl){
    	if(sessionValue == null || sessionValue == ''){
    		alert('로그인 후 사용 가능합니다.');
    		location.href = loginUrl;
    	}else{
	...
	function fn_remove(paramUserReplyNo){
		...
		if(confirm("정말 삭제하시겠습니까?")){
			location.href = "${context}/work/proreply/deleteProductReply.do?userReplyNo=" + userReplyNo + "&productCode=" + productCode;
		}
	}
...
<jsp:include page="../common/top.jsp"></jsp:include>
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-6" align="center">
                	<img id="image" src="${context}/javaImg/${dsProduct.PRODUCT_IMAGE}" class="img-rounded img-responsive">
                	<script type="text/javascript">
                ...
                <br><br><br>
                  <table class="table table-user-information">
                    ...
                    <tr>
                      ...
                      <tr>
                        <td>정보</td>
                        <td id="info">${dsProduct.PRODUCT_INFO}</td>
                      </tr>
                      <tr>
                        <td>출간일</td>
                        <td id="date">${dsProduct.PRODUCT_DATE}</td>
                      </tr>
                      <tr>
                        <td>남은 수량</td>
                  ...
                  <br><br>
                  <div>
                	  <button id ="buyBtn" type="button" class="btn btn-primary btn-sm" onclick="fn_buy('${sessionScope.userCode}', '${loginUrl}')">
                	  <i class="fa fa-credit-card fa-2x">&nbsp;바로구매</i></button>
                      <button id ="cartBtn" type="button" class="btn btn-warning btn-sm" onclick="fn_cart('${sessionScope.userCode}', '${loginUrl}')">
                      <i class="fa fa-shopping-cart fa-2x">&nbsp;장바구니</i></button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <c:if test="${sessionScope.id != null && dsSell.SELL_YN == 'Y'}">
    <div class="container">
		<div class="row" style="margin-top:40px;">
			<div class="col-md-12">
		    	<div class="well well-sm">
		            <div class="text-right">
		                <a class="btn btn-danger btn-lg" href="#reviews-anchor" id="open-review-box"><b>REVIEW 입력</b></a>
		            </div>

		            <div class="row" id="post-review-box" style="display:none;">
		                <div class="col-md-12">
		                    <form id="createReply" accept-charset="UTF-8" action="${context}/work/proreply/createProductReply.do" method="post">
		                        <input id="ratings-hidden" name="markRating" type="hidden">
		                        <textarea class="form-control animated" cols="50" id="userReply" name="userReply" placeholder="REVIEW를 입력하세요..." rows="5"></textarea>

		                        <div class="text-right">
			                        <c:if test="${dsSell.MARK_YN == 'N'}">
		                        ...
		                        <input type="hidden" id="productCode" name="productCode" value="${dsSell.PRODUCT_CODE}">
		                        <input type="hidden" id="sellCode" name="sellCode" value="${dsSell.SELL_CODE}">
		                        <input type="hidden" id="markYn" name="markYn" value="${dsSell.MARK_YN}">
		                    </form>
		                </div>
		            </div>
		        </div>
