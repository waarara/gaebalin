			                    ...
			                    <tbody>
			                    	<c:forEach items="${dsProductList}" var="dsProductList" varStatus="productIdx">
			                         <tr>
			                            ...
			                            <td style="text-align: center; vertical-align: middle;">
			                            <a href="${context}/work/product/retrieveProduct.do?productCode=${dsProductList.PRODUCT_CODE}">${dsProductList.PRODUCT_NAME}</a>
			                            </td>
			                            <td style="text-align: center; vertical-align: middle;">${dsProductList.PRODUCT_INFO}</td>
			                            <td style="text-align: center; vertical-align: middle;">${dsProductList.PRODUCT_DATE}</td>
			                            ...
			                            <td style="text-align: center; vertical-align: middle;">${dsProductList.PRODUCT_COUNT}권</td>
			                            <c:choose >
			                            	<c:when test="${dsProductList.RANK <= 10}">
					                            <td style="text-align: center; vertical-align: middle;">인기</td>
											</c:when>
											<c:otherwise>
