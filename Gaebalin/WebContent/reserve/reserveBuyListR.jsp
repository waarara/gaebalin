...
<head>
	<meta charset="UTF-8">
	<meta name="description" content="reserveBuyListR.jsp">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title>필요없는 페이지</title>
			        ...
			        <div class="panel-body">
			            <div class="table-responsive">
			                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
			                    ...
			                    <tbody>
			                    	<c:forEach items="${dsReserveBuyList}" var="dsReserveBuyList" varStatus="buyIdx">
			                         <tr>
			                         	<td style="text-align: center; vertical-align: middle;">${buyIdx.count}</td>
			                            <td style="text-align: center; vertical-align: middle;">
										<img name="image" width="110px" height="110px" src="${context}/conImg/${dsReserveBuyList.EVENT_IMAGE}" class="img-thumbnail">
											<script type="text/javascript">
											 	var eventCategoryCd = '${dsReserveBuyList.EVENT_CATEGORY_CD}';
			                            ...
			                            <td style="text-align: center; vertical-align: middle;">${dsReserveBuyList.EVENT_TITLE}</td>
			                            <td style="text-align: center; vertical-align: middle;">${dsReserveBuyList.EVENT_UNIT_PRICE}원</td>
			                            <td style="text-align: center; vertical-align: middle;">${dsReserveBuyList.RESERVE_POP}</td>
			                            <td style="text-align: center; vertical-align: middle;">${dsReserveBuyList.RESERVE_PRICE}원</td>
			                            <td style="text-align: center; vertical-align: middle;">
			                            	<button type="button" class="btn btn-warning" onclick="fn_review('${dsReserveBuyList.EVENT_NO}')">후기 쓰러가기</button>
			                            </td>
			                         </tr>
			                        </c:forEach>
			                    </tbody>
