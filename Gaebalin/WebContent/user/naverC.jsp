...
<meta name="viewport"
	content="initial-scale=1.0; maximum-scale=1.0; minimum-scale=1.0; user-scalable=yes; width=device-width;height=device-height" />
		<meta name="description" content="naverC.jsp">
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>네이버 간편 회원가입</title>
...
// 		$('#dataTables-example').dataTable();
	...
	function fn_setDetailInfo(){
		...
		var imageName = userImage.split("/").reverse()[0];
		
        var imageType = imageName.split(".")[1];
        console.log(test + "." + imageType);
        if(imageName == "img_profile.png"){
	        $("#userImage").val("img_profile.png");    	
        } else {
	        $("#userImage").val(test + "." + imageType);
        }
...
<jsp:include page="../common/top.jsp"></jsp:include>
	...
	<div class="container">
	<form id="joinFrm" method="post" action="${context}/work/user/createNaverUser.do" role="form">
