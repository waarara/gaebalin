...
<script type="text/javascript">
	...
	function fn_setDetailInfo() {
		...
		$("#sample6_postcode").val('${dsUser.postNum}');
...
<body>
	...
	<div class="container">
		<div class="jumbotron jumbotron-info"
			...
			<h1>
				<font color="black"><strong>정보수정</strong>&nbsp;<span
					class="glyphicon glyphicon glyphicon-pencil"></span></font>
			</h1>
		</div>
	</div>
	<div class="container">
		<form id="joinFrm" method="post"
			action="${context}/work/user/updateUser.do" role="form">
			<div class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input class="form-control" type="text" id="name" name="nickName"
				...
				<div class="form-group">
					...
					<div class="col-md-2">
						<input class="form-control" type="text" id="phone1" maxlength="3"
							required="required" onkeydown="return fn_showKeyCode(event)" />
					</div>
					<div class="col-md-2">
					...
					<div class="col-md-2">
						<input class="form-control" type="text" id="phone3" maxlength="4"
							required="required" onkeydown="return fn_showKeyCode(event)" />
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-2">
						<input class="form-control" type="text" id="sample6_postcode"
							readonly="readonly" placeholder="우편번호" required="required">
					</div>
					<span class="col-md-1"> <input type="button"
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input class="form-control" type="text" id="sample6_address"
							readonly="readonly" placeholder="주소"> <input
							class="form-control" type="text" id="sample6_detailAddress"
		...
		<form id="ajaxform" action="${context}/work/product/saveFile.do"
