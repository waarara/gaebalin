...
<head>
    ...
    $(document).ready(function(){
    	...
    	$("#sort").change(function(){
    		...
    		if(sort == 'stockJA'){
				url = "${context}/work/product/retrieveStatisticsForStock.do?productCategoryCd=JA";
    		}else if(sort == 'stockPY'){
				url = "${context}/work/product/retrieveStatisticsForStock.do?productCategoryCd=PY";
    		}else if(sort == 'stockED'){
				url = "${context}/work/product/retrieveStatisticsForStock.do?productCategoryCd=ED";
    		}else if(sort == 'stockCC'){
				url = "${context}/work/product/retrieveStatisticsForStock.do?productCategoryCd=CC";
    		}else if(sort == 'sell'){
		...
		<div class="row">
			<div class="col-md-3">
				<select class="form-control" id="sort" name="sort">
					<option value="stockJA">재고현황[자바]</option>
					<option value="stockPY">재고현황[파이썬]</option>
					<option value="stockED">재고현황[교양서적]</option>
					<option value="stockCC">재고현황[C언어]</option>
