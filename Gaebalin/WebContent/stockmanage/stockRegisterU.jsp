...
<jsp:include page="../common/top.jsp"></jsp:include>
	...
	<form id="updateProduct" method="post" action="${context}/work/product/updateProduct.do" role="form">
		<div class="form-horizontal">
			...
			<div class="form-group">
				<label for="productInfo" class="control-label col-md-2"><b>지은이</b></label>
				<div class="col-md-3">
					<input class="form-control" type="text" id="productInfo" name="productInfo" required="required" onkeydown="return fn_showKeyCode(event)"/>
				</div>
			</div>
			<div class="form-group">
				<label for="productDate" class="control-label col-md-2"><b>출간일</b></label>
				<div class="col-md-3">
					<input class="form-control" type="text" id="productDate" name="productDate" required="required" onkeydown="return fn_showKeyCode(event)"/>
				</div>
			</div>
			<div class="form-group">
