...
public class ProreplyBean implements Serializable{
	...
	public ProreplyBean(String productCode, String userCode, int userReplyNo,
	...
	public String toString() {
		...
		builder.append("ProreplyBean [productCode=");
